...
# Emited when player is hit by a mob.
signal hit
...
# Vertical impulse applied to character upon jumping in meters per second.
@export var jump_impulse = 20
# Vertical impulse applied to character upon bouncing over a mob in
# meters per second.
